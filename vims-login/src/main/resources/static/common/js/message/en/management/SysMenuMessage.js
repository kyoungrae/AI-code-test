...
Message.Label.Array["SYS_MENU.TITLE_LIST"] = " Menu Config";
Message.Label.Array["SYS_MENU.TITLE_MODIFY"] = " Modify";
Message.Label.Array["SYS_MENU.TITLE_REGISTER"] = " Register";

Message.Label.Array["SYS_MENU.CHECK.MENU_CODE"] = "Please enter Menu Code";
Message.Label.Array["SYS_MENU.CHECK.MENU_NAME_KR"] = "Please enter Menu Name (KR)";
...
Message.Label.Array["SYS_MENU.CHECK.TOP_MENU_CODE"] = "Please enter Top Menu Code";
Message.Label.Array["SYS_MENU.CHECK.URL"] = "Please enter URL";
Message.Label.Array["SYS_MENU.CHECK.USE_YN"] = "Please enter Use Y/N";
Message.Label.Array["SYS_MENU.CHECK.SYSTEM_CREATE_DATE"] = "Please enter Create Date";
Message.Label.Array["SYS_MENU.CHECK.SYSTEM_CREATE_USERID"] = "Please enter Creator ID";
Message.Label.Array["SYS_MENU.CHECK.SYSTEM_UPDATE_DATE"] = "Please enter Update Date";
Message.Label.Array["SYS_MENU.CHECK.SYSTEM_UPDATE_USERID"] = "Please enter Updater ID";
Message.Label.Array["SYS_MENU.CHECK.MENU_SEQUENCE"] = "Please enter Menu Sequence";
...
Message.Label.Array["SYS_MENU.MENU_NAME_KR"] = "Menu Name (KR)";
...
Message.Label.Array["SYS_MENU.TOP_MENU_CODE"] = "Top Menu Code";
Message.Label.Array["SYS_MENU.URL"] = "URL";
Message.Label.Array["SYS_MENU.USE_YN"] = "Use Y/N";
Message.Label.Array["SYS_MENU.SYSTEM_CREATE_DATE"] = "Created Date";
Message.Label.Array["SYS_MENU.SYSTEM_CREATE_USERID"] = "Creator ID";
Message.Label.Array["SYS_MENU.SYSTEM_UPDATE_DATE"] = "Updated Date";
Message.Label.Array["SYS_MENU.SYSTEM_UPDATE_USERID"] = "Updater ID";
Message.Label.Array["SYS_MENU.MENU_SEQUENCE"] = "Menu Sequence";
...
Message.Label.Array["SYS_MENU.REGISTER_MENU_ACCESS_GROUP"] = "Access Group Management";
Message.Label.Array["SYS_MENU.REGISTER_MENU_ACCESS_GROUP_BTN"] = "Access Rights";